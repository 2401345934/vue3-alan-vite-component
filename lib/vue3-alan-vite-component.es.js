...
var StarrySky = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["__scopeId", "data-v-7932ec82"]]);
...
class DrawImage$1 {
  ...
  async draw() {
    const { ctx: ctx2, renderList: renderList2 } = this;
    const urls = renderList2.filter((v) => v.type === "image").map((v) => v.src);
    await this.loadImgs(urls);
    renderList2.forEach((v) => {
      v.align && (ctx2.textAlign = v.align);
      if (v.type === "image") {
        ctx2.beginPath();
        ctx2.save();
        if (v.clipCircle) {
          ctx2.lineWidth = v.clipLineWidth;
          ctx2.strokeStyle = v.clipStrokeStyle;
          ctx2.arc((v.x + v.width / 2) * this.bl, (v.y + v.width / 2) * this.bl, v.width / 2 * this.bl, 0, Math.PI * 2);
          ctx2.stroke();
          ctx2.clip();
        }
        ctx2.drawImage(this.images[v.src], v.x * this.bl, v.y * this.bl, v.width * this.bl, v.height * this.bl);
        ctx2.restore();
      } else if (v.type === "text") {
        ctx2.fillStyle = v.fillStyle;
        ctx2.font = `${v.fontSize * this.bl}px \u5B8B\u4F53`;
        ctx2.fillText(v.text, v.x * this.bl, v.y * this.bl);
      }
    });
  }
  async loadImgs(urls) {
...
var DigitalScroll = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["__scopeId", "data-v-45c23839"]]);
...
var AlanButton = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["__scopeId", "data-v-3313c991"]]);
...
var CodeBackgroundWall = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["__scopeId", "data-v-f79d4606"]]);
...
var BackTop = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["__scopeId", "data-v-2fc49e58"]]);
BackTop.install = (App) => {
...
var DynamicCard = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["render", _sfc_render], ["__scopeId", "data-v-393e8e1d"]]);
...
var TherMometer = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-47e5d9bc"]]);
  ...
  setup(__props) {
    ...
    onMounted(() => {
      ...
      function drawCircle(cx, cy, radius, color, shadow) {
        ...
        ctx2.shadowBlur = shadow ? radius : 0;
  ...
  setup(__props) {
    ...
    onMounted(() => {
      ...
      function showTime() {
        ...
        const gradient = ctx2.createRadialGradient(250, 250, 5, 250, 250, 300);
        gradient.addColorStop(0, "#03303a");
        gradient.addColorStop(1, "#03303a");
        ctx2.fillStyle = gradient;
        ctx2.fillRect(0, 0, props.width, props.height);
        ctx2.beginPath();
        ctx2.strokeStyle = "#87CEFA";
        ctx2.arc(250, 250, 215, degToRad(0), degToRad(hours * 30 - 90));
        ctx2.stroke();
        ctx2.beginPath();
        ctx2.strokeStyle = "#20B2AA";
        ctx2.arc(250, 250, 220, degToRad(0), degToRad(smoothmin * 6 - 90));
        ctx2.stroke();
        ctx2.beginPath();
        ctx2.strokeStyle = "#AFEEEE";
        ctx2.arc(250, 250, 225, degToRad(0), degToRad(smoothsec * 6 - 90));
        ctx2.stroke();
        ctx2.font = "25px Helvetica Bold";
        ctx2.fillStyle = "#7FFFD4";
        ctx2.fillText(today + "/\u661F\u671F" + date, 150, 230);
        ctx2.font = "23px Helvetica Bold";
        ctx2.fillStyle = "#7FFFD4";
        ctx2.fillText(time, 190, 280);
      }
...
_sfc_main$4.install = (App) => {
  App.component(_sfc_main$4.name, Button);
};
...
var VideoRecording = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-177b98b4"]]);
  ...
  setup(__props) {
    ...
    onMounted(() => {
      ...
      const render = () => {
        ...
        var radial = ctx2.createRadialGradient(p.x, p.y, p.r, p.x, p.y, p.r * 3);
...
_sfc_main$2.install = (App) => {
  App.component(_sfc_main$2.name, Button);
};
...
var DrawImage = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-bddadfbe"]]);
  ...
  setup(__props) {
    ...
    onMounted(() => {
      ...
      const init = (event) => {
        ...
        client.endY = pageY;
        ctx2.beginPath();
        ctx2.lineWidth = props.config.lineWidth;
        ctx2.strokeStyle = props.config.strokeStyle;
        ctx2.lineCap = props.config.lineCap;
        ctx2.lineJoin = props.config.lineJoin;
        ctx2.moveTo(client.endX, client.endY);
...
var index$1 = "";
const components = [StarrySky, DigitalScroll, AlanButton, CodeBackgroundWall, BackTop, TherMometer, _sfc_main$5, DynamicCard, _sfc_main$7, VideoRecording, _sfc_main$4, _sfc_main$2, DrawImage, _sfc_main];
const install = (App) => {
...
var index = { install };
export { BackTop as AlanBackTop, AlanButton, _sfc_main as CanvasAutograph, _sfc_main$4 as Clocks, CodeBackgroundWall, DigitalScroll, DrawImage, DynamicCard, _sfc_main$2 as Spotlight, StarrySky, _sfc_main$7 as TakingPictures, TherMometer, VideoRecording, _sfc_main$5 as YuanWar, index as default };
