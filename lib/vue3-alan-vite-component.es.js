import { defineComponent, ref, onMounted, openBlock, createElementBlock, createElementVNode, Fragment, renderList, normalizeClass, renderSlot, useSlots, onBeforeUnmount, createCommentVNode, normalizeStyle, toDisplayString, unref, withDirectives, vShow, createTextVNode, pushScopeId, popScopeId } from "vue";
...
const _hoisted_1$6 = { class: "starry-sky-bg" };
const _hoisted_2$2 = { class: "stars" };
const __default__$6 = {
...
var StarrySky = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-63922582"]]);
...
var DigitalScroll = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-35598430"]]);
...
var AlanButton = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-466500e7"]]);
...
const _hoisted_1$4 = ["height", "width"];
const __default__$3 = {
...
var CodeBackgroundWall = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-377a0a92"]]);
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        createElementVNode("div", {
          ...
          !slotDefault ? (openBlock(), createElementBlock("div", _hoisted_1$3, " \u8FD4\u56DE ")) : createCommentVNode("", true),
          renderSlot(_ctx.$slots, "default", {}, void 0, true)
        ], 2)
      ]);
    };
...
var BackTop = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-7ec40d52"]]);
BackTop.install = (App) => {
  ...
  methods: {
    initData() {
      ...
      this.cards = arr.map((_, index2) => {
        return this.computedStyle(index2, this.cardNumber);
      });
    },
    resetData(style) {
      this.style = style;
...
const _hoisted_1$2 = { class: "AnimationCards" };
const _hoisted_2$1 = { class: "demo-content" };
const _hoisted_3$1 = { class: "animation-cards-box" };
      ...
      createElementVNode("div", _hoisted_3$1, [
        (openBlock(true), createElementBlock(Fragment, null, renderList($data.cards, (styles, index2) => {
          return openBlock(), createElementBlock("div", {
            ...
            createElementVNode("span", null, "Card " + toDisplayString(index2 + 1), 1)
          ], 14, _hoisted_4$1);
        }), 128))
      ])
    ])
...
var DynamicCard = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render], ["__scopeId", "data-v-3b11853c"]]);
...
var index$1 = "";
const components = [StarrySky, DigitalScroll, AlanButton, CodeBackgroundWall, BackTop, TherMometer, _sfc_main, DynamicCard];
const install = (App) => {
...
var index = { install };
export { BackTop as AlanBackTop, AlanButton, CodeBackgroundWall, DigitalScroll, DynamicCard, StarrySky, TherMometer, _sfc_main as YuanWar, index as default };
